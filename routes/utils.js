...
// Default Icon (Gray Music Note)
const DEFAULT_ICON = "data:image/svg+xml;base64,";
...
function getPresetAssignment(ip, slotId) {
    ...
    if (!match) match = library.find(item => item.slot === slotId && !item.speakerIp);
